<template>
  <div id="addQuestionPage">
    ...
    <a-form :model="questionContent" :style="{ width: '480px' }" label-align="left" auto-label-width
      @submit="handleSubmit">
      ...
      <a-form-item label="题目列表" :content-flex="false" :merge-props="false">
        ...
        <!-- 遍历每道题目 -->
        <div v-for="(question, index) in questionContent" :key="index" style=" margin-top: 20px;">
          <a-space size="large">
            <h3>题目 {{ index + 1 }}</h3>
          ...
          <a-space size="large">
            ...
            <a-button size="small" @click="addQuestionOption(question, question.options?.length || 0)">
              底部添加选项
            </a-button>
          </a-space>
          <a-form-item v-for="(option, optionIndex) in question.options" :key="optionIndex"
            :label="`选项 ${optionIndex + 1}`" :content-flex="false" :merge-props="false">
            ...
            <a-space size="large">
              ...
              <a-button size="mini" status="danger" @click="deleteQuestionOption(question, optionIndex as any)">
                删除选项
              </a-button>
            </a-space>
          </a-form-item>
      ...
      <a-form-item>
        <a-button type="primary" html-type="submit" style="width: 120px; margin: 0 auto;">
          提交
        </a-button>
      </a-form-item>
    </a-form>
